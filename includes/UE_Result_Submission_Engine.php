...
if ($ElectionResults_Name_1 != "") {
	$ElectionResults_LINE_1 = "1 - " . $ElectionResults_Name_1 . ", " . $ElectionResults_AddressLn1_1 . ", " . $ElectionResults_AddressLn2_1 . ", " . $ElectionResults_AddressLnCity_1 . ", " . $ElectionResults_AddressLnState_1 . ", " . $ElectionResults_AddressLnZip_1 . ", " . $ElectionResults_Phone_1 . ", " . $ElectionResults_Email_1 . ", " . $ElectionResults_DOB_1;
} else {
	$ElectionResults_LINE_1 = "";
}

if ($ElectionResults_Name_2 != "") {
	$ElectionResults_LINE_2 = "2 - " . $ElectionResults_Name_2 . ", " . $ElectionResults_AddressLn1_2 . ", " . $ElectionResults_AddressLn2_2 . ", " . $ElectionResults_AddressLnCity_2 . ", " . $ElectionResults_AddressLnState_2 . ", " . $ElectionResults_AddressLnZip_2 . ", " . $ElectionResults_Phone_2 . ", " . $ElectionResults_Email_2 . ", " . $ElectionResults_DOB_2;
} else {
	$ElectionResults_LINE_2 = "";
}

if ($ElectionResults_Name_3 != "") {
	$ElectionResults_LINE_3 = "3 - " . $ElectionResults_Name_3 . ", " . $ElectionResults_AddressLn1_3 . ", " . $ElectionResults_AddressLn2_3 . ", " . $ElectionResults_AddressLnCity_3 . ", " . $ElectionResults_AddressLnState_3 . ", " . $ElectionResults_AddressLnZip_3 . ", " . $ElectionResults_Phone_3 . ", " . $ElectionResults_Email_3 . ", " . $ElectionResults_DOB_3;
} else {
	$ElectionResults_LINE_3 = "";
}

if ($ElectionResults_Name_4 != "") {
	$ElectionResults_LINE_4 = "4 - " . $ElectionResults_Name_4 . ", " . $ElectionResults_AddressLn1_4 . ", " . $ElectionResults_AddressLn2_4 . ", " . $ElectionResults_AddressLnCity_4 . ", " . $ElectionResults_AddressLnState_4 . ", " . $ElectionResults_AddressLnZip_4 . ", " . $ElectionResults_Phone_4 . ", " . $ElectionResults_Email_4 . ", " . $ElectionResults_DOB_4;
} else {
	$ElectionResults_LINE_4 = "";
}

if ($ElectionResults_Name_5 != "") {
	$ElectionResults_LINE_5 = "5 - " . $ElectionResults_Name_5 . ", " . $ElectionResults_AddressLn1_5 . ", " . $ElectionResults_AddressLn2_5 . ", " . $ElectionResults_AddressLnCity_5 . ", " . $ElectionResults_AddressLnState_5 . ", " . $ElectionResults_AddressLnZip_5 . ", " . $ElectionResults_Phone_5 . ", " . $ElectionResults_Email_5 . ", " . $ElectionResults_DOB_5;
} else {
	$ElectionResults_LINE_5 = "";
}

if ($ElectionResults_Name_6 != "") {
	$ElectionResults_LINE_6 = "6 - " . $ElectionResults_Name_6 . ", " . $ElectionResults_AddressLn1_6 . ", " . $ElectionResults_AddressLn2_6 . ", " . $ElectionResults_AddressLnCity_6 . ", " . $ElectionResults_AddressLnState_6 . ", " . $ElectionResults_AddressLnZip_6 . ", " . $ElectionResults_Phone_6 . ", " . $ElectionResults_Email_6 . ", " . $ElectionResults_DOB_6;
} else {
	$ElectionResults_LINE_6 = "";
}

if ($ElectionResults_Name_7 != "") {
	$ElectionResults_LINE_7 = "7 - " . $ElectionResults_Name_7 . ", " . $ElectionResults_AddressLn1_7 . ", " . $ElectionResults_AddressLn2_7 . ", " . $ElectionResults_AddressLnCity_7 . ", " . $ElectionResults_AddressLnState_7 . ", " . $ElectionResults_AddressLnZip_7 . ", " . $ElectionResults_Phone_7 . ", " . $ElectionResults_Email_7 . ", " . $ElectionResults_DOB_7;
} else {
	$ElectionResults_LINE_7 = "";
}

if ($ElectionResults_Name_8 != "") {
	$ElectionResults_LINE_8 = "8 - " . $ElectionResults_Name_8 . ", " . $ElectionResults_AddressLn1_8 . ", " . $ElectionResults_AddressLn2_8 . ", " . $ElectionResults_AddressLnCity_8 . ", " . $ElectionResults_AddressLnState_8 . ", " . $ElectionResults_AddressLnZip_8 . ", " . $ElectionResults_Phone_8 . ", " . $ElectionResults_Email_8 . ", " . $ElectionResults_DOB_8;
} else {
	$ElectionResults_LINE_8 = "";
}

if ($ElectionResults_Name_9 != "") {
	$ElectionResults_LINE_9 = "9 - " . $ElectionResults_Name_9 . ", " . $ElectionResults_AddressLn1_9 . ", " . $ElectionResults_AddressLn2_9 . ", " . $ElectionResults_AddressLnCity_9 . ", " . $ElectionResults_AddressLnState_9 . ", " . $ElectionResults_AddressLnZip_9 . ", " . $ElectionResults_Phone_9 . ", " . $ElectionResults_Email_9 . ", " . $ElectionResults_DOB_9;
} else {
	$ElectionResults_LINE_9 = "";
}

if ($ElectionResults_Name_10 != "") {
	$ElectionResults_LINE_10 = "10 - " . $ElectionResults_Name_10 . ", " . $ElectionResults_AddressLn1_10 . ", " . $ElectionResults_AddressLn2_10 . ", " . $ElectionResults_AddressLnCity_10 . ", " . $ElectionResults_AddressLnState_10 . ", " . $ElectionResults_AddressLnZip_10 . ", " . $ElectionResults_Phone_10 . ", " . $ElectionResults_Email_10 . ", " . $ElectionResults_DOB_10;
} else {
	$ElectionResults_LINE_10 = "";
}

if ($ElectionResults_Name_11 != "") {
	$ElectionResults_LINE_11 = "11 - " . $ElectionResults_Name_11 . ", " . $ElectionResults_AddressLn1_11 . ", " . $ElectionResults_AddressLn2_11 . ", " . $ElectionResults_AddressLnCity_11 . ", " . $ElectionResults_AddressLnState_11 . ", " . $ElectionResults_AddressLnZip_11 . ", " . $ElectionResults_Phone_11 . ", " . $ElectionResults_Email_11 . ", " . $ElectionResults_DOB_11;
} else {
	$ElectionResults_LINE_11 = "";
}

if ($ElectionResults_Name_12 != "") {
	$ElectionResults_LINE_12 = "12 - " . $ElectionResults_Name_12 . ", " . $ElectionResults_AddressLn1_12 . ", " . $ElectionResults_AddressLn2_12 . ", " . $ElectionResults_AddressLnCity_12 . ", " . $ElectionResults_AddressLnState_12 . ", " . $ElectionResults_AddressLnZip_12 . ", " . $ElectionResults_Phone_12 . ", " . $ElectionResults_Email_12 . ", " . $ElectionResults_DOB_12;
} else {
	$ElectionResults_LINE_12 = "";
}

if ($ElectionResults_Name_13 != "") {
	$ElectionResults_LINE_13 = "13 - " . $ElectionResults_Name_13 . ", " . $ElectionResults_AddressLn1_13 . ", " . $ElectionResults_AddressLn2_13 . ", " . $ElectionResults_AddressLnCity_13 . ", " . $ElectionResults_AddressLnState_13 . ", " . $ElectionResults_AddressLnZip_13 . ", " . $ElectionResults_Phone_13 . ", " . $ElectionResults_Email_13 . ", " . $ElectionResults_DOB_13;
} else {
	$ElectionResults_LINE_13 = "";
}

if ($ElectionResults_Name_14 != "") {
	$ElectionResults_LINE_14 = "14 - " . $ElectionResults_Name_14 . ", " . $ElectionResults_AddressLn1_14 . ", " . $ElectionResults_AddressLn2_14 . ", " . $ElectionResults_AddressLnCity_14 . ", " . $ElectionResults_AddressLnState_14 . ", " . $ElectionResults_AddressLnZip_14 . ", " . $ElectionResults_Phone_14 . ", " . $ElectionResults_Email_14 . ", " . $ElectionResults_DOB_14;
} else {
	$ElectionResults_LINE_14 = "";
}

if ($ElectionResults_Name_15 != "") {
	$ElectionResults_LINE_15 = "15 - " . $ElectionResults_Name_15 . ", " . $ElectionResults_AddressLn1_15 . ", " . $ElectionResults_AddressLn2_15 . ", " . $ElectionResults_AddressLnCity_15 . ", " . $ElectionResults_AddressLnState_15 . ", " . $ElectionResults_AddressLnZip_15 . ", " . $ElectionResults_Phone_15 . ", " . $ElectionResults_Email_15 . ", " . $ElectionResults_DOB_15;
} else {
	$ElectionResults_LINE_15 = "";
}
...
UE Form Processor Release: 1/13/14a
***********************************************
...
/*
	...
	// Replaced with logging to Devils Teatable DB for 2014 UE Season
...
// Log Form Submission to DB
	...
	$Unit_esc = mysqli_real_escape_string($db_link, $UnitInformation_Troop);
	$ElectionData_esc = mysqli_real_escape_string($db_link, $Email_Body);

	// Set up Query
	$db_query = "INSERT INTO arc_UnitElectionYouth (Year, Chapter, Unit, ElectionData) VALUES ('" . $Year . "', '" . $Chapter_esc . "', '" . $Unit_esc . "', '" . $ElectionData_esc . "')";
